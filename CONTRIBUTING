...
Here are some important resources:
  ...
  * [Bugs](https://github.com/mean-dao/mean-core/issues)

## Reporting a Bug

  * If you find a bug, please submit it to this repo as a new Github issue.
  * Before you submit a new bug, please make sure it was not previously submitted by searching [existing issues](https://github.com/mean-dao/mean-core/issues).
...
## Submitting bug fixes
  ...
  * If you create a fix for a bug, please submit it as a [Github pull request to this repo](https://github.com/mean-dao/mean-core/pulls).
